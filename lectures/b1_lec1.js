                ...
                <ol style="padding-right: 20px; line-height: 1.8;">
                    <li style="margin-bottom: 10px;">
                        ...
                        <div class="math-block" style="margin: 6px 0;">
                            $$\\vec{u} = \\frac{\هناك خطأ بسيط في إغلاق الـ `div` الخاصة بالقسم الثالث (تكرر وسم `<div class="math-block">` ولم يُغلق وسم القسم بشكل متوازن)، بالإضافة إلى إمكانية تبسيط وتحسين كود الـ HTML والـ LaTeX ليظهر بأفضل تنسيق داخل موقعك.

إليك الكود كامل بعد التصحيح والتنظيم:
            ...
            <div class="content-box" style="margin-top: 15px; border-right: 4px solid var(--accent); background: rgba(255, 255, 255, 0.03); padding: 14px;">
                ...
                <ol style="padding-right: 20px; line-height: 1.8;">
                    ...
                    <li style="margin-bottom: 10px;">
                        ...
                        <div class="math-block" style="margin: 6px 0;">
                            $$\\vec{u} = \\frac{\\vec{PQ}}{\\Vert{}\\vec{PQ}\\Vert{}}$$
                        </div>
                    </li>
                    <li style="margin-bottom: 10px;">
