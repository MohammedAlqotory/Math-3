        ...
        <div class="content-box">
            ...
            <ol style="padding-right: 20px;">
                ...
                <li style="margin-bottom: 8px;">
                    ...
                    <p style="color: var(--text-muted); margin-top: 3px;">
                        تكون المعادلة <b>متجانسة (Homogeneous)</b> إذا كان الطرف الأيمن الخالي من \(y\) ومشتقاته يساوي صفراً: \(F(x, y, y', \dots, y^{(n)}) = 0\). أما إذا كان هناك حد يعتمد على \(x\) فقط، تسمى <b>غير متجانسة (Non-homogeneous)</b>.
                    </p>
                </li>
            </ol>
        </div>
